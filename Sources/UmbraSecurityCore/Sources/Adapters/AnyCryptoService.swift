...
public final class AnyCryptoService: CryptoServiceProtocol {
    ...
    private let _encrypt: @Sendable (SecureBytes, SecureBytes) async -> Result<SecureBytes, SecurityError>
    private let _decrypt: @Sendable (SecureBytes, SecureBytes) async -> Result<SecureBytes, SecurityError>
    ...
    private let _encryptSymmetric: @Sendable (SecureBytes, SecureBytes, SecurityConfigDTO) async -> SecurityResultDTO
    private let _decryptSymmetric: @Sendable (SecureBytes, SecureBytes, SecurityConfigDTO) async -> SecurityResultDTO
    private let _encryptAsymmetric: @Sendable (SecureBytes, SecureBytes, SecurityConfigDTO) async -> SecurityResultDTO
    private let _decryptAsymmetric: @Sendable (SecureBytes, SecureBytes, SecurityConfigDTO) async -> SecurityResultDTO
    ...
    public init<T: CryptoServiceProtocol>(_ service: T) {
