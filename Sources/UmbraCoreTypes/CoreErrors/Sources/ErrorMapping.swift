// ErrorMapping for UmbraCoreTypes
//
// Maps between UmbraCoreTypes errors and CoreErrors types
...
@Sendable public func mapToCoreErrors(_ error: Error) -> Error {
...
@Sendable public func mapFromCoreErrors(_ error: Error) -> Error {
