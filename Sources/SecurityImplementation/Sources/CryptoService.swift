...
public final class CryptoService: CryptoServiceProtocol {
  ...
  public func generateKeyDTO(config: SecurityConfigDTO) async -> SecurityResultDTO {
    await serviceCore.generateKey(config: config)
  }
  ...
  public func encryptSymmetricDTO(
    ...
    await serviceCore.encryptSymmetric(data: data, key: key, config: config)
  }
  ...
  public func decryptSymmetricDTO(
    ...
    await serviceCore.decryptSymmetric(data: data, key: key, config: config)
  }
  ...
  public func hashDTO(
    ...
    await serviceCore.hash(data: data, config: config)
  }
  ...
  public func encryptAsymmetricDTO(
    ...
    await serviceCore.encryptAsymmetric(data: data, publicKey: publicKey, config: config)
  }
  ...
  public func decryptAsymmetricDTO(
    ...
    await serviceCore.decryptAsymmetric(data: data, privateKey: privateKey, config: config)
  }
}
