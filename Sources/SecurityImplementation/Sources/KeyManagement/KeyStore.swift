...
final class KeyStore {
  ...
  func retrieveKey(withIdentifier identifier: String) -> Result<SecureBytes, UmbraErrors.Security.Protocols> {
  ...
  func deleteKey(withIdentifier identifier: String) -> Result<Void, UmbraErrors.Security.Protocols> {
