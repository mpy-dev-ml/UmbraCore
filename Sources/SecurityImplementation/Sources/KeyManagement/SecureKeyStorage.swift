...
public final class SecureKeyStorage: SafeStorage, Sendable {
  ...
  public func get(identifier: String) async -> SecureBytes? {
    return await actor.get(identifier: identifier)
  }
  ...
  public func storeSecurely(data: SecureBytes, identifier: String) async -> Result<Void, UmbraErrors.Security.Protocols> {
  ...
  /// - Parameter identifier: The identifier of the key to delete
  /// - Returns: A result indicating success or an error
  public func deleteSecurely(identifier: String) async -> Result<Void, UmbraErrors.Security.Protocols> {
    if await contains(identifier: identifier) {
  ...
  public func retrieveSecurely(identifier: String) async -> Result<SecureBytes, UmbraErrors.Security.Protocols> {
    return await retrieveKey(withIdentifier: identifier)
  }
  ...
  public func storeKey(_ key: SecureBytes, withIdentifier identifier: String) async -> Result<Void, UmbraErrors.Security.Protocols> {
    return await storeSecurely(data: key, identifier: identifier)
  }
}
