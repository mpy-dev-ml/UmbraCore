...
// Enhanced SecurityError implementation using the new error architecture
//
...
public enum SecurityErrorDomain: String, CaseIterable, Sendable {
    ...
    public var description: String {
        switch self {
        case .bookmarkError:
            return "Failed to create or resolve a security bookmark"
        case .accessError:
            return "Security access error occurred"
        case .encryptionFailed:
            return "Data encryption operation failed"
        case .decryptionFailed:
            return "Data decryption operation failed"
        case .invalidKey:
            return "The cryptographic key is invalid or corrupted"
        case .keyGenerationFailed:
            return "Failed to generate cryptographic key"
        case .certificateInvalid:
            return "Certificate validation failed"
        case .unauthorisedAccess:
            return "Unauthorised access attempt detected"
...
public struct SecurityError: DomainError {
    ...
    public init(
        ...
        self.errorCode = code
        self.errorDescription = description ?? code.description
        self.source = source
