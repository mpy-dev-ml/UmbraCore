...
public actor SecurityServiceNoCrypto {
    ...
    private static var _nonIsolatedStateStorage: [ObjectIdentifier: CoreServicesTypesNoFoundation.ServiceState] = [:]
    ...
    private static func updateNonIsolatedState(for id: ObjectIdentifier, newState: CoreServicesTypesNoFoundation.ServiceState) {
