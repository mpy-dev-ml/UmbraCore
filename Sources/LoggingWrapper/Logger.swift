...
public class Logger: LoggerProtocol {
    ...
    internal static func toSwiftyBeaverLevel(_ level: LogLevel) -> SwiftyBeaver.Level {
        switch level {
        case .critical, .error:
            return .error
        case .warning:
    ...
    internal static func fromSwiftyBeaverLevel(_ level: SwiftyBeaver.Level) -> LogLevel {
        switch level {
        case .error:
            return .error
        case .warning:
