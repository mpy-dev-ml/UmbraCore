...
extension XPCServiceProtocolBasic {
  ...
  public func convertNSDataToData(_ nsData: NSData) -> Data {
  ...
  public func convertNSDataToSecureBytes(_ nsData: NSData) -> SecureBytes {
...
extension XPCServiceProtocolStandard {
  ...
  public func createXPCError(message: String, code: Int) -> NSError {
    NSError(
  ...
  public func convertResultToNSObject(_ result: Result<some NSObject, Error>) -> NSObject? {
    switch result {
  ...
  public func convertBoolResultToNSNumber(_ result: Result<Bool, Error>) -> NSNumber? {
    switch result {
      case let .success(value):
