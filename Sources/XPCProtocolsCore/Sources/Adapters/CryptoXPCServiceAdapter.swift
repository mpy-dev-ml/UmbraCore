...
public final class CryptoXPCServiceAdapter: NSObject, 
  ...
  public func exportKey(keyIdentifier: String) async -> Result<SecureBytes, XPCSecurityError> {
    // Mock implementation
    return .failure(.internalError(reason: "Key export not implemented in adapter"))
  }
  ...
  public func importKey(
    ...
    // Mock implementation
    return .failure(.internalError(reason: "Key import not implemented in adapter"))
  }
  ...
  public func sign(
    ...
    // Mock implementation
    return .failure(.internalError(reason: "Signing not implemented in adapter"))
  }
  ...
  public func verify(
    ...
    // Mock implementation
    return .failure(.internalError(reason: "Verification not implemented in adapter"))
  }
  ...
  public func listKeys() async -> Result<[String], XPCSecurityError> {
    // Mock implementation
    return .success(["mock-key-1", "mock-key-2"])
  }
  ...
  public func importKey(
    ...
    // Mock implementation
    return .success(keyIdentifier ?? "generated-key-id")
  }
