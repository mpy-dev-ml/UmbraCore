...
public enum XPCProtocolsCore {
  ...
  public static func createServiceClient(
    serviceConnection: NSXPCConnection,
  ...
  public enum ProtocolLevel: Int, CaseIterable {
    ...
    public var protocolType: Any.Type {
      switch self {
      case .basic:
        return XPCServiceProtocolBasic.self
      case .standard:
        return XPCServiceProtocolStandard.self
      case .complete:
        return XPCServiceProtocolComplete.self
      }
    }
    ...
    public var identifier: String {
      switch self {
      case .basic:
        return "com.umbra.xpc.service.protocol.basic"
      case .standard:
        return "com.umbra.xpc.service.protocol.standard"
      case .complete:
