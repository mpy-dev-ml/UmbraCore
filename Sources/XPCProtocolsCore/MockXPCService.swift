...
//  XPCProtocolsCore
//
//  Created by Cascade on 19/03/2025.
//
...
public final class MockXPCService: XPCServiceProtocolStandard, XPCServiceProtocolBasic {
    ...
    public func synchroniseKeys(_ keys: [String: Data]) async -> Result<[String: Data], SecurityError> {
    ...
    public func encryptSecureData(_ data: Data, keyIdentifier _: String) async -> Result<Data, SecurityError> {
        // Just return the data unchanged for testing
        .success(data)
    }

    public func decryptSecureData(_ data: Data, keyIdentifier _: String) async -> Result<Data, SecurityError> {
        // Just return the data unchanged for testing
        .success(data)
    }
    ...
    public func verify(signature _: Data, for _: Data, keyIdentifier _: String) async -> Result<Bool, SecurityError> {
        .success(true)
    }
