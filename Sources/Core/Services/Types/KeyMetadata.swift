...
public extension KeyManagementTypes.KeyMetadata {
    /// Raw representation that matches the canonical type's raw metadata
    struct RawRepresentation: Sendable {
        public var status: KeyManagementTypes.KeyStatus
        public let storageLocation: KeyManagementTypes.StorageLocation
    ...
    static func from(rawRepresentation: RawRepresentation) -> KeyManagementTypes.KeyMetadata {
...
public extension KeyManagementTypes.KeyStatus {
    ...
    func toRawRepresentation() -> KeyManagementTypes.KeyStatus {
        self
    }
