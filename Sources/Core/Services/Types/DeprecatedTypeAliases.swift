...
extension KeyManagementTypes.KeyMetadata {
    ...
    public static func from(legacy: KeyMetadataLegacy) -> KeyManagementTypes.KeyMetadata {
        ...
        return KeyManagementTypes.KeyMetadata(
    ...
    public func toLegacy() -> KeyMetadataLegacy {
        ...
        return KeyMetadataLegacy(
            status: self.status,
            storageLocation: self.storageLocation,
            accessControls: translateAccessControlsToLegacy(from: self.accessControls),
    ...
    private static func translateAccessControls(from legacyControls: KeyMetadataLegacy.AccessControls) -> KeyManagementTypes.KeyMetadata.AccessControls {
    ...
    private func translateAccessControlsToLegacy(from controls: KeyManagementTypes.KeyMetadata.AccessControls) -> KeyMetadataLegacy.AccessControls {
        switch controls {
        case .none:
            return .none
        case .requiresAuthentication:
