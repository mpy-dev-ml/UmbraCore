...
@Sendable
public func mapSPCSecurityError(_ error: SPCSecurityError) -> Error {
  mapFromSecurityProtocolsCore(error)
}
...
@Sendable
public func mapFromSPC(_ error: Error) -> NSError {
  mapFromSecurityProtocolsCore(error)
}
...
@Sendable
public func mapSPCError(_ error: SPCSecurityError) -> Error {
...
@Sendable
public func createSPCConfig(from params: [String: Any]) -> SPCConfigDTO {
  createSecurityProtocolsCoreConfig(from: params)
}
...
@Sendable
public func mapToSPCOperation(_ operation: String) -> SPCOperation? {
  SPCOperation(rawValue: operation)
}
...
@Sendable
public func mapToSPCOperationWithErrorHandling(_ operation: String) throws
-> SecurityOperation {
  try mapToSecurityProtocolsCoreOperation(operation)
}
...
@Sendable
public func mapSPCResult(_ result: SPCResultDTO) -> [String: Any] {
  mapSecurityProtocolsCoreResult(result)
}
...
@Sendable
public func mapFromSPCResult(_ result: SPCResultDTO)
-> (success: Bool, data: Data?, metadata: [String: String]) {
