...
public class SecurityProtocolsCoreProvider {
    ...
    public func performOperation(
        ...
        return await provider.performSecureOperation(
            operation: operation,
            config: config
        )
    }
    ...
    public func generateKey(
        ...
        return await provider.cryptoService.generateRandomData(length: size / 8)
    }
    ...
    public func retrieveKey(
        ...
        return await provider.keyManager.retrieveKey(withIdentifier: identifier)
    }
    ...
    public func storeKey(
        ...
        return await provider.keyManager.storeKey(key, withIdentifier: identifier)
    }
    ...
    public func deleteKey(
        ...
        return await provider.keyManager.deleteKey(withIdentifier: identifier)
    }
    ...
    public func rotateKey(
        ...
        return await provider.keyManager.rotateKey(
    ...
    public func listKeyIdentifiers() async -> Result<[String], SecurityError> {
        ...
        return await provider.keyManager.listKeyIdentifiers()
    }
}
