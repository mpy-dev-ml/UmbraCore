...
public final class DummyXPCService: XPCServiceProtocolStandard {
    ...
    public func deleteKey(keyId: String) async -> Result<Void, XPCProtocolsCore.SecurityError> {
        .success(())
    }
