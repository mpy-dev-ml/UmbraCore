...
public extension ModuleInformation {
    /// Default empty compatible versions
    static var compatibleVersions: [String: ClosedRange<SemanticVersion>] {
        [:]
    }
    ...
    static func isCompatible(with moduleName: String, version: SemanticVersion) -> Bool {
