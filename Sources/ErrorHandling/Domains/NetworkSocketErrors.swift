...
public extension UmbraErrors.Network {
    /// Socket-specific network errors
    enum Socket: Error, UmbraError, StandardErrorCapabilities {
...
public extension UmbraErrors.Network.Socket {
    /// Create a connection refused error
    static func makeConnectionRefused(
        host: String,
        port: Int,
        file _: String = #file,
        line _: Int = #line,
