...
public extension UmbraErrors.Network {
    ...
    enum Core: Error, UmbraError, StandardErrorCapabilities, NetworkErrors {
        // Connection errors
...
public extension UmbraErrors.Network.Core {
    ...
    static func makeDataCorruption(
        reason: String,
        file _: String = #file,
        line _: Int = #line,
        function _: String = #function
