...
public extension UmbraErrors.Resource {
    ...
    enum File: Error, UmbraError, StandardErrorCapabilities {
        // File access errors
        /// File not found
...
public extension UmbraErrors.Resource.File {
    /// Create an error for a file that could not be found
    static func makeFileNotFound(
        path: String,
        file _: String = #file,
        line _: Int = #line,
    ...
    static func makeDirectoryNotFound(
        path: String,
        file _: String = #file,
        line _: Int = #line,
        function _: String = #function
    ...
    static func makePermissionError(
        path: String,
        operation: String,
        file _: String = #file,
        line _: Int = #line,
    ...
    static func makeFileAlreadyExists(
        path: String,
        file _: String = #file,
        line _: Int = #line,
        function _: String = #function
    ...
    static func makeDirectoryAlreadyExists(
        path: String,
        file _: String = #file,
        line _: Int = #line,
        function _: String = #function
    ...
    static func makeCreateDirectoryError(
        path: String,
        reason: String,
        file _: String = #file,
        line _: Int = #line,
    ...
    static func makeFileInUseError(
        path: String,
    ...
    static func makeReadOnlyFileSystemError(
        path: String,
        file _: String = #file,
        line _: Int = #line,
        function _: String = #function
    ...
    static func makeFileCorruptError(
        path: String,
        reason: String,
        file _: String = #file,
        line _: Int = #line,
    ...
    static func makeInvalidPathError(
        path: String,
        reason: String,
        file _: String = #file,
        line _: Int = #line,
