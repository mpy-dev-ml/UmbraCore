...
public extension UmbraErrors.Security {
    ...
    enum Protocols: Error, UmbraError, StandardErrorCapabilities, Equatable {
...
public extension UmbraErrors.Security.Protocols {
    ...
    static func makeEncryptionFailed(
        message: String,
        file _: String = #file,
        line _: Int = #line,
        function _: String = #function
    ...
    static func makeDecryptionFailed(
        message: String,
        file _: String = #file,
        line _: Int = #line,
        function _: String = #function
    ...
    static func makeRandomGenerationFailed(
        message: String,
        file _: String = #file,
        line _: Int = #line,
        function _: String = #function
    ...
    static func makeStorageOperationFailed(
        message: String,
        file _: String = #file,
        line _: Int = #line,
        function _: String = #function
    ...
    static func makeNotImplemented(
        message: String,
        file _: String = #file,
        line _: Int = #line,
        function _: String = #function
