...
public extension UmbraErrors.XPC {
...
public extension UmbraErrors.XPC.Core {
    ...
    static func makeServiceUnavailable(
        serviceName: String,
        file _: String = #file,
        line _: Int = #line,
        function _: String = #function
    ...
    static func makeMessageSendFailed(
        serviceName: String,
        reason: String,
        file _: String = #file,
        line _: Int = #line,
    ...
    static func makeSecurityViolation(
        serviceName: String,
        reason: String,
        file _: String = #file,
        line _: Int = #line,
