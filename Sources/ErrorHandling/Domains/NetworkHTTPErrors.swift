...
public extension UmbraErrors.Network {
    ...
    enum HTTP: Error, UmbraError, StandardErrorCapabilities {
        // Client errors (4xx)
...
public extension UmbraErrors.Network.HTTP {
    /// Create an error from HTTP status code
    static func makeFromStatusCode(
        _ statusCode: Int,
        reason: String,
        resource: String? = nil,
        file _: String = #file,
