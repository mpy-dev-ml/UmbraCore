...
public extension ErrorHandlingInterfaces.ErrorContext {
    /// Create a new error context with no additional information
    static func empty() -> ErrorHandlingInterfaces.ErrorContext {
...
public extension Error {
    ...
    var asSecurityCoreError: SecurityCoreErrorWrapper? {
    ...
    var asSecurityXPCError: SecurityXPCErrorWrapper? {
    ...
    var asSecurityProtocolsError: SecurityProtocolsErrorWrapper? {
