...
final class ErrorMappingTests: XCTestCase {
    ...
    func testMappingSecurityErrors() {
        ...
        XCTAssertTrue(errorString.contains("Invalid key size"), "Mapped error should contain the reason text")
    ...
    func testMappingProtocolErrors() {
        ...
        // Verify mapping
        XCTAssertNotNil(securityError)
        XCTAssertTrue(String(describing: securityError).contains("Bad signature"), 
    ...
    func testErrorChainMapping() {
        ...
        let encryptionError = UmbraErrors.GeneralSecurity.Core.encryptionFailed(reason: "Encryption failed due to invalid key")
        ...
        // Verify error contains the reason text
        let errorString = String(describing: securityError)
        XCTAssertTrue(errorString.contains("invalid key") || errorString.contains("invalid key"),
