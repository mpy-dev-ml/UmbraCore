...
final class KeyStatusTests: XCTestCase {
    ...
    func testCanonicalKeyStatusTimestampConversion() {
        ...
        let timestamp: Int64 = 1627084800 // July 24, 2021 00:00:00 UTC
    ...
    func testRawStatusConversion() {
        let date = Date()
        let timestamp: Int64 = 1627084800
        ...
        XCTAssertEqual(KeyStatus.from(rawStatus: .pendingDeletionWithTimestamp(timestamp)), .pendingDeletionWithTimestamp(timestamp))
    }
    ...
    func testRawStatusEquality() {
        ...
        let timestamp1: Int64 = Int64(date1.timeIntervalSince1970)
        let timestamp2: Int64 = Int64(date2.timeIntervalSince1970)
        let timestamp3: Int64 = Int64(date3.timeIntervalSince1970)
        ...
        XCTAssertEqual(KeyStatus.RawStatus.pendingDeletion(date1), KeyStatus.RawStatus.pendingDeletion(date2))
        XCTAssertNotEqual(KeyStatus.RawStatus.pendingDeletion(date1), KeyStatus.RawStatus.pendingDeletion(date3))
