...
public extension StorageLocation {
    ...
    func toCoreServicesNoFoundation() -> /* CoreServicesTypesNoFoundation.StorageLocation */ Any {
    ...
    /// - Parameter coreServicesNoFoundation: The CoreServicesTypesNoFoundation.StorageLocation to convert from
    /// - Returns: The equivalent canonical StorageLocation
    static func fromCoreServicesNoFoundation(_ coreServicesNoFoundation: Any) -> StorageLocation {
        // This is a type-erased conversion to avoid direct import
        // The actual type is CoreServicesTypesNoFoundation.StorageLocation
