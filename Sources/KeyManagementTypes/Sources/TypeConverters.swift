    ...
    public static func from(rawStatus: RawStatus) -> KeyStatus {
        switch rawStatus {
            ...
            case let .pendingDeletionWithTimestamp(timestamp):
                return .pendingDeletionWithTimestamp(timestamp)
        }
    }
...
public extension StorageLocation {
    ...
    func toRawLocation() -> TypeConverters.RawLocations {
        switch self {
    ...
    /// - Parameter rawLocation: Raw location value
    /// - Returns: Canonical StorageLocation
    static func from(rawLocation: TypeConverters.RawLocations) -> StorageLocation {
...
public extension KeyStatus {
    ...
    func toRawStatus() -> TypeConverters.RawStatus {
        switch self {
    ...
    /// - Parameter rawStatus: Raw status value
    /// - Returns: Canonical KeyStatus
    static func from(rawStatus: TypeConverters.RawStatus) -> KeyStatus {
...
public extension KeyMetadata {
    ...
    func toRawMetadata() -> TypeConverters.RawMetadata {
        return TypeConverters.RawMetadata(
    ...
    /// - Parameter rawMetadata: Raw metadata value
    /// - Returns: Canonical KeyMetadata
    static func from(rawMetadata: TypeConverters.RawMetadata) -> KeyMetadata {
...
public extension StorageLocation {
    ...
    typealias RawLocations = TypeConverters.RawLocations
}

public extension KeyStatus {
    /// Type alias for raw status type
    typealias RawStatus = TypeConverters.RawStatus
}

public extension KeyMetadata {
    /// Type alias for raw metadata type
    typealias RawMetadata = TypeConverters.RawMetadata
}
