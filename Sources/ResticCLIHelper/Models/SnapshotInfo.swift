...
public struct SnapshotInfo: Codable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.programVersion = try container.decode(String.self, forKey: .programVersion)
        self.summary = try container.decodeIfPresent(SnapshotSummary.self, forKey: .summary)
...
public struct SnapshotSummary: Codable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        // Decode other properties
        self.filesNew = try container.decode(Int.self, forKey: .filesNew)
        self.filesChanged = try container.decode(Int.self, forKey: .filesChanged)
        self.filesUnmodified = try container.decode(Int.self, forKey: .filesUnmodified)
        self.dirsNew = try container.decode(Int.self, forKey: .dirsNew)
        self.dirsChanged = try container.decode(Int.self, forKey: .dirsChanged)
        self.dirsUnmodified = try container.decode(Int.self, forKey: .dirsUnmodified)
        self.dataBlobs = try container.decode(Int.self, forKey: .dataBlobs)
        self.treeBlobs = try container.decode(Int.self, forKey: .treeBlobs)
        self.dataAdded = try container.decode(Int64.self, forKey: .dataAdded)
        self.dataAddedPacked = try container.decode(Int64.self, forKey: .dataAddedPacked)
        self.totalFilesProcessed = try container.decode(Int.self, forKey: .totalFilesProcessed)
        self.totalBytesProcessed = try container.decode(Int64.self, forKey: .totalBytesProcessed)
    }
}
