...
public struct MockSnapshotInfo {
    ...
    public init(id: String, time: Date, tree: String, paths: [String], hostname: String, username: String, parent: String? = nil) {
        self.id = id
        self.time = time
        self.tree = tree
        self.paths = paths
...
public final class MockResticRepository {
    ...
    public func createDirectoryStructure(_ structure: [String: String]) throws {
        for (path, content) in structure {
            ...
            try createTestFile(name: (path as NSString).lastPathComponent,
                             content: content,
    ...
    public func initialize() async throws {
        ...
        if process.terminationStatus != 0 {
            ...
            throw NSError(domain: "ResticError",
