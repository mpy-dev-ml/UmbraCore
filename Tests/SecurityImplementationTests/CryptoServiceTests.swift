...
final class CryptoServiceTests: XCTestCase {
    ...
    func testEncryptAndDecryptSymmetric() async {
        ...
        let encryptResult = await cryptoService.encryptSymmetric(data: plaintext, key: key, config: config)
        ...
        let decryptResult = await cryptoService.decryptSymmetric(data: encryptedData, key: key, config: config)
    ...
    func testInvalidKey() async {
        ...
        let encryptResult = await cryptoService.encryptSymmetric(data: plaintext, key: invalidKey, config: config)
