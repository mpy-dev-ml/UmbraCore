...
final class MockRepositoryManagementTests: XCTestCase {
    ...
    func testInitAndCheck() throws {
        ...
        XCTAssertTrue(initOutput.contains("initialized"), "Init output should confirm repository was initialized")
        ...
        XCTAssertEqual(processExecutor.executionHistory[0].arguments[0], "init", "First command should be init")
        XCTAssertEqual(processExecutor.executionHistory[1].arguments[0], "check", "Second command should be check")
    }
    ...
    func testBackupAndRestore() throws {
        ...
        XCTAssertTrue(snapshotOutput.contains("abcdef1234567890"), "Snapshot output should contain the snapshot ID")
        ...
        XCTAssertEqual(processExecutor.executionHistory[0].arguments[0], "backup", "First command should be backup")
        XCTAssertEqual(processExecutor.executionHistory[1].arguments[0], "snapshots", "Second command should be snapshots")
        XCTAssertEqual(processExecutor.executionHistory[2].arguments[0], "restore", "Third command should be restore")
    }
    ...
    func testRepositoryCopy() throws {
        ...
        XCTAssertEqual(processExecutor.executionHistory[0].arguments[0], "backup", "First command should be backup")
        XCTAssertEqual(processExecutor.executionHistory[1].arguments[0], "snapshots", "Second command should be snapshots")
        XCTAssertEqual(processExecutor.executionHistory[2].arguments[0], "copy", "Third command should be copy")
    }
}
