...
final class ProgressTests: XCTestCase {
  ...
  func testBackupProgressParsing() throws {
    ...
    XCTAssertEqual(handler.backupProgress[0].totalBytes, 1048576)
    XCTAssertEqual(handler.backupProgress[0].processedFiles, 50)
    XCTAssertEqual(handler.backupProgress[0].processedBytes, 524288)
    ...
    XCTAssertEqual(handler.backupProgress[1].totalBytes, 1048576)
    XCTAssertEqual(handler.backupProgress[1].processedFiles, 75)
    XCTAssertEqual(handler.backupProgress[1].processedBytes, 786432)
  ...
  func testRestoreProgressParsing() throws {
    ...
    XCTAssertEqual(handler.restoreProgress[0].totalBytes, 524288)
    XCTAssertEqual(handler.restoreProgress[0].restoredFiles, 25)
    XCTAssertEqual(handler.restoreProgress[0].restoredBytes, 262144)
