...
final class DTOConvertersTests: XCTestCase {
    ...
    func testNotificationDTOForSecurityError() {
        ...
        let timestamp: UInt64 = 1625000000
    ...
    func testDateExtensions() {
        // Arrange
        let date = Date(timeIntervalSince1970: 1625000000)
        
        // Act & Assert
        XCTAssertEqual(date.timestampInSeconds, 1625000000)
        XCTAssertEqual(Date.fromTimestamp(1625000000).timeIntervalSince1970, 1625000000)
    }
    ...
    func testScheduleDTODateConversion() {
        ...
        if let windowStartDate = windowStartDate, let windowEndDate = windowEndDate {
    ...
    func testScheduledTaskDTODateConversion() {
        ...
        let schedule = ScheduleDTO.daily(
            startTimestamp: UInt64(now.timeIntervalSince1970 - 604800)  // A week ago
        )
