...
final class SchedulingDTOTests: XCTestCase {
    ...
    func testScheduleDTOInitialization() {
        ...
        XCTAssertEqual(schedule.startTimestamp, 1620000000)
        XCTAssertEqual(schedule.endTimestamp, 1630000000)
    ...
    func testScheduleDTOFactoryMethods() {
        ...
        XCTAssertEqual(daily.startTimestamp, 1620000000)
        ...
        XCTAssertEqual(weekly.startTimestamp, 1620000000)
        ...
        XCTAssertEqual(monthly.startTimestamp, 1620000000)
    ...
    func testScheduledTaskDTOInitialization() {
        ...
        let task = ScheduledTaskDTO(
            ...
            lastRunTimestamp: 1625000000,
            nextRunTimestamp: 1625086400,
            creationTimestamp: 1620000000,
            runCount: 5
        )
        ...
        XCTAssertEqual(task.lastRunTimestamp, 1625000000)
        XCTAssertEqual(task.nextRunTimestamp, 1625086400)
        XCTAssertEqual(task.creationTimestamp, 1620000000)
    ...
    func testScheduledTaskDTOCalculateNextRun() {
        ...
        let dailyTask = ScheduledTaskDTO(
            ...
            creationTimestamp: UInt64(now.timeIntervalSince1970) - 172800  // Created 2 days ago
        )
