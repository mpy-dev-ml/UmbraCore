...
public struct ErrorHandlingDomains.UmbraErrors.Security.ProtocolsDTO: Error, Sendable, Equatable,
CustomStringConvertible {
  ...
  public static func unknown(details: String?=nil) -> ErrorHandlingDomains.UmbraErrors.Security
  .ProtocolsDTO {
    var detailsDict: [String: String]=[:]
    if let details {
      detailsDict["message"]=details
    }
    return ErrorHandlingDomains.UmbraErrors.Security.ProtocolsDTO(
      code: .unknown,
      details: detailsDict
    )
  }
  ...
  /// - Returns: An ErrorHandlingDomains.UmbraErrors.Security.ProtocolsDTO
  public static func invalidInput(details: String) -> ErrorHandlingDomains.UmbraErrors.Security
  .ProtocolsDTO {
  ...
  /// - Returns: An ErrorHandlingDomains.UmbraErrors.Security.ProtocolsDTO
  public static func keyNotFound(identifier: String) -> ErrorHandlingDomains.UmbraErrors.Security
  .ProtocolsDTO {
    ErrorHandlingDomains.UmbraErrors.Security.ProtocolsDTO(
      code: .keyNotFound,
  ...
  /// - Returns: An ErrorHandlingDomains.UmbraErrors.Security.ProtocolsDTO
  public static func unsupportedOperation(operation: String) -> ErrorHandlingDomains.UmbraErrors
  .Security.ProtocolsDTO {
    ErrorHandlingDomains.UmbraErrors.Security.ProtocolsDTO(
  ...
  /// - Returns: An ErrorHandlingDomains.UmbraErrors.Security.ProtocolsDTO
  public static func permissionDenied(details: String) -> ErrorHandlingDomains.UmbraErrors.Security
  .ProtocolsDTO {
    ErrorHandlingDomains.UmbraErrors.Security.ProtocolsDTO(
