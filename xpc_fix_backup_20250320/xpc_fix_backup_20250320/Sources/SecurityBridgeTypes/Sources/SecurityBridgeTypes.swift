...
public typealias ErrorHandlingDomains.UmbraErrors.Security.Protocols = SecurityError
...
public struct ErrorHandlingDomains.UmbraErrors.Security.ProtocolsDTO: Error, Sendable, Equatable, CustomStringConvertible {
    ...
    /// - Returns: An ErrorHandlingDomains.UmbraErrors.Security.ProtocolsDTO
    public static func unknown(details: String? = nil) -> ErrorHandlingDomains.UmbraErrors.Security.ProtocolsDTO {
        var detailsDict: [String: String] = [:]
        if let details {
            detailsDict["message"] = details
        }
        return ErrorHandlingDomains.UmbraErrors.Security.ProtocolsDTO(code: .unknown, details: detailsDict)
    }

    /// Create an invalid input error
    /// - Parameter details: Description of the invalid input
    /// - Returns: An ErrorHandlingDomains.UmbraErrors.Security.ProtocolsDTO
    public static func invalidInput(details: String) -> ErrorHandlingDomains.UmbraErrors.Security.ProtocolsDTO {
    ...
    /// - Returns: An ErrorHandlingDomains.UmbraErrors.Security.ProtocolsDTO
    public static func keyNotFound(identifier: String) -> ErrorHandlingDomains.UmbraErrors.Security.ProtocolsDTO {
        ErrorHandlingDomains.UmbraErrors.Security.ProtocolsDTO(
            code: .keyNotFound,
    ...
    /// - Returns: An ErrorHandlingDomains.UmbraErrors.Security.ProtocolsDTO
    public static func unsupportedOperation(operation: String) -> ErrorHandlingDomains.UmbraErrors.Security.ProtocolsDTO {
        ErrorHandlingDomains.UmbraErrors.Security.ProtocolsDTO(
    ...
    /// - Returns: An ErrorHandlingDomains.UmbraErrors.Security.ProtocolsDTO
    public static func permissionDenied(details: String) -> ErrorHandlingDomains.UmbraErrors.Security.ProtocolsDTO {
        ErrorHandlingDomains.UmbraErrors.Security.ProtocolsDTO(
